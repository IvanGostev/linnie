        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6 col-12 wow fadeInUp" data-wow-delay=".4s">
                <div class="single-service">
                    ...
                    <p>Техническое обслуживание, приведение в соответствие с действующими ФЗ, регламентами к единому
                        стандарту.</p>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="section-title">
                    ...
                    <p class="wow fadeInUp" data-wow-delay=".6s">Здесь вы можете</br>Ознакомиться с некоторыми из наших
                        работ.</p>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="section-title">
                    ...
                    <p class="wow fadeInUp" data-wow-delay=".6s">В данном разделе Вы можете ознакомится с новостями
                        компании.</p>
                </div>
            </div>
        </div>

...
@section('content')
    ...
    <section class="content">
        ...
        <div class="container-fluid">
            <form action="{{route('checklist.task.update', $task->id)}}" enctype="multipart/form-data" method="post">
                @csrf
@method('patch')
                <div class="row">
                    <!-- left column -->
                    <div class="col-md-12">
                        ...
                        <div class="card card-secondary">
                            <div class="card-header">
                                <h3 class="card-title">Задача: {{$task->title}}</h3>
                            </div>
                            <!-- /.card-header -->
                            <!-- form start -->
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-secondary">
                            <div class="card-header">
                                <h3 class="card-title">Форма создания отчета</h3>
                            </div>
                            <!-- /.card-header -->
                            <!-- form start -->

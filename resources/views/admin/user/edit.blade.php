                                ...
                                <div class="active tab-pane" id="settings">
                                    <form class="form-horizontal" method="post" action="{{route('admin.user.update', $user->id)}}" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group row">
                                            <label for="inputName" class="col-sm-2 col-form-label">Старая фотография</label>
                                            @isset($user->img)
                                                <img src="{{ asset('storage/' . $user->img)}}" width="85px" style="padding: 10px">
                                            @endisset
                                            <label for="inputName" class="col-sm-2 col-form-label">Фотография</label>
